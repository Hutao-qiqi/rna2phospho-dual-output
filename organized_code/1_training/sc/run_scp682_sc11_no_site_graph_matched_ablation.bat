...
set OUT=%ROOT%\02_results\single_cell\20260529_scp682_sc11_current_main_no_site_graph_ablation_v1
set LOG=%OUT%\logs
...
"D:\Tools\anaconda3\python.exe" "%ROOT%\03_code\single_cell\modeling\train_scp682_sc11_expanded_scnet_site_gnn.py" ^
  ...
  --site-graph-weight 0.0 ^
  --site-graph-scale 0.0 ^
  --site-graph-topk 12 ^
  --site-graph-candidate-limit 0 ^
  --site-graph-max-aux-nodes 0 ^
  --huber-beta 0.5 ^
  --loss-type huber ^
  --warmup-epochs 8 ^
  --val-fraction 0.12 ^
