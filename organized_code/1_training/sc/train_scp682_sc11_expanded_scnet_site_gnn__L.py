...
def train_model(features, present, y, mask, meta, contexts, pathway_names, target_rows, target_pathway_prior, transfer_prior, full_transfer, site_graph, args, out_dir):
    ...
    transfer_source = "scp682_main" if args.scp682_main_transfer_dir else ("scp68222" if args.scp68222_transfer_dir else "none")
    teacher_name = (
...
def main():
    ...
    if args.scp682_main_transfer_dir:
    ...
    elif args.scp68222_transfer_dir:
        transfer_source = "scp68222"
        transfer_root = root / args.scp68222_transfer_dir
        ...
        if args.full_transfer_scale > 0:
            ...
            if full_transfer:
                ...
                log("full_transfer unavailable; falling back to attention prior only")
    ...
    transfer_prefix = "scp682_main" if transfer_source == "scp682_main" else "scp68222"
    ...
    if full_transfer:
        full_transfer["pathway_alignment"].to_csv(out_dir / "tables" / f"scp682_sc11_{transfer_prefix}_full_pathway_alignment.tsv", sep="\t", index=False)
        ...
        json.dump(
            {
                ...
                "scp682_main_transfer_used": bool(args.scp682_main_transfer_dir and args.transfer_alpha > 0),
