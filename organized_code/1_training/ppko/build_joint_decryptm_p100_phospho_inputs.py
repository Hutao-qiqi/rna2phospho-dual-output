"""
模型: SCP682-PPKO
作用: 构建 decryptM 与 P100 输入
输入: ./data_root/ 下的训练或验证数据
输出: ./data_root/ 下的模型、表格或评估结果
依赖: torch, numpy, pandas, scipy, scikit-learn
原始路径: .\remote_scripts\build_joint_decryptm_p100_phospho_inputs.py
原始版本: NA
"""
