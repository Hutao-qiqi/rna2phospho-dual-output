...
out_dir=$root/02_results/model_validation/scp682main1_random70_b0_headreset_tau10_u192_20260818
...
common=(
  ...
  --site-scaling identity_logscale --profile-mse-weight 1
  ...
  --learning-rate 0.00005 --maximum-finetune-updates 192
  --target-study-residual --study-residual-tau 10 --study-residual-min-overlap 5
  --output-dir "$out_dir"
)
"$python" "$code" "${common[@]}" >"$out_dir/logs/training.stdout.log" 2>"$out_dir/logs/training.stderr.log"
