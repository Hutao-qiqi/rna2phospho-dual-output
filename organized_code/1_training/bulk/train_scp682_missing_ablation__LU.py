...
def main():
    ...
    ap.add_argument(
        ...
        default="/data/lsy/Infinite_Stream/SCP682-main/inputs/general_baseline_internal_cptac_pdc_phosphosite.parquet",
    )
    ap.add_argument(
        "--rna-path",
        default="/data/lsy/Infinite_Stream/01_data/multi_omics/processed/pancancer_multi_task_locked_v2/rna_log2_tpm_paired.parquet",
    )
    ap.add_argument(
        "--sample-manifest-path",
        default="/data/lsy/Infinite_Stream/01_data/multi_omics/processed/pancancer_multi_task_locked_v2/sample_manifest.tsv",
    )
    ...
    ap.add_argument(
        "--edge-mode",
        choices=["all", "copheemap", "copheeksa", "kstar", "no_copheemap", "no_copheeksa", "no_kstar"],
        default="all",
