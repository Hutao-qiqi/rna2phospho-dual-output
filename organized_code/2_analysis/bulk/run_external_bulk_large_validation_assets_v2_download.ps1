...
$Stdout = Join-Path $LogDir "formal_stdout.log"
$Stderr = Join-Path $LogDir "formal_stderr.log"
$ExitCode = Join-Path $LogDir "formal_exit_code.txt"
$Started = Join-Path $LogDir "formal_started.txt"
