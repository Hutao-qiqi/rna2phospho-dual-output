...
$RunScript = Join-Path $CodeDir "run_external_bulk_large_validation_assets_v2_download.ps1"
...
$TaskName = "SCP682_EXTERNAL_BULK_LARGE_ASSETS_V2"
$TaskCommand = "powershell.exe -NoProfile -ExecutionPolicy Bypass -File `"$RunScript`""
$TaskLog = Join-Path $LogDir "schtask_launch.log"
