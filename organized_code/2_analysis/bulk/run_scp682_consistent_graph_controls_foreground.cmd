...
echo scheduled_start %DATE% %TIME% > "%OUT%\logs\launcher.start.txt"
"%PYTHON%" "%SCRIPT%" > "%OUT%\logs\launcher.stdout.log" 2> "%OUT%\logs\launcher.stderr.log"
echo scheduled_end %DATE% %TIME% >> "%OUT%\logs\launcher.start.txt"
